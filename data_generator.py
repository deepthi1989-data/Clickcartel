...
CONFIG = {
    ...
    "raw_batch_customer_path": raw_batch_customer_path,
    "raw_batch_product_path": raw_batch_product_path,
...
def generate_batch_data():
    ...
    customers_path = CONFIG["raw_batch_customer_path"]
    ...
    products_path = CONFIG["raw_batch_product_path"]
...
def generate_streaming_events(infinite=None, stream_events_per_batch=None, stream_batch_interval_s=None):
    ...
    """
    if infinite is None:
        infinite = CONFIG.get("STREAM_INFINITE", False)
